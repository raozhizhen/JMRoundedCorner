...
- (void)setupViews {
    ...
    [_button jm_setImageWithJMRadius:JMRadiusMake(10, 0, 10, 0) image:[UIImage imageNamed:@"avatar"]];
    ...
    _label.text = @"label";
    [_label jm_setImageWithJMRadius:JMRadiusMake(0, 10, 0, 10) borderColor:[UIColor redColor] borderWidth:0.5 backgroundColor:[UIColor whiteColor]];
